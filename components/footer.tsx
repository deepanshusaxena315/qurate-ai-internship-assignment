...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-quinary to-gray-950/90 backdrop-blur-sm border-t border-white/10 py-8 sm:py-12 px-4 sm:px-6 mt-auto">
      <div className="max-w-6xl mx-auto">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          {/* Company Info */}
          <div className="col-span-1 sm:col-span-2">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Qurate AI</h3>
            <p className="text-gray-300 text-xs sm:text-sm leading-relaxed mb-4">
              Transforming conversations into insights. We revolutionize how businesses collect and process information through intelligent conversation interfaces.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
              ...
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">API Reference</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Status</a></li>
              <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Contact Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <div className="text-xs sm:text-sm text-gray-400 text-center sm:text-left">
            © 2024 Qurate AI. All rights reserved.
          </div>
