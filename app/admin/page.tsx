      ...
      <div className="max-w-7xl mx-auto bg">
        ...
        >
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Form Management</h2>
            </div>
            <motion.button 
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-800">Active Forms</h3>
            </div>
            <motion.div 
            ...
            >
              <div className="flex flex-col items-center space-y-3">
                ...
                <div>
                  <p className="text-gray-600 font-medium">No active forms available.</p>
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-800">Inactive Forms</h3>
            </div>
            <motion.div 
              className="bg-gray-50 rounded-xl p-8 text-center"
              initial={{ opacity: 0, scale: 0.95 }}
            ...
            >
              <div className="flex flex-col items-center space-y-3">
                ...
                <div>
                  <p className="text-gray-600 font-medium">No inactive forms available.</p>
                  <p className="text-gray-500 text-sm">All forms are currently active or none exist.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm">Inactive Forms</p>
